      ...
      {unverifiedEmail ? (
        <div className="space-y-4">
          <div className="text-center py-4">
            ...
            <p className="text-sm font-medium text-gray-900 dark:text-white mb-1">Verify your email first</p>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
              We sent a confirmation link to <span className="font-medium text-gray-700 dark:text-gray-300">{unverifiedEmail}</span>.
          ...
          <Button fullWidth variant="secondary" onClick={() => { setUnverifiedEmail(null); setError(''); setResendSent(false); }}>
            Try another email
          </Button>
        </div>
      ) : (
