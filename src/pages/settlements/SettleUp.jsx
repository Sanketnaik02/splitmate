...
export default function SettleUp() {
  ...
  const { setActiveGroup, activeGroup, members, expenses, settlements, addSettlement } = useGroup();
  ...
  const handleSettle = (fromId, toId, amount) => {
    const fromMember = members.find(m => String(m.userId) === String(fromId));
    const toMember = members.find(m => String(m.userId) === String(toId));
    if (!fromMember || !toMember) {
      showToast('Could not identify settlement participants', 'error');
      return;
    }
    ...
    const toName = toMember.displayName || 'Unknown';
