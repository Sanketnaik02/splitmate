  ...
  return (
    <AppLayout userName={user?.displayName || 'User'}>
      <div className="pt-1 space-y-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">Choose a plan that works for you. Upgrade anytime.</p>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-300 mt-0.5">{plan.maxGroups} groups max</p>
                    </div>
                  </div>
                  <div className="text-right">
                    {plan.price === 0 ? (
                      ...
                      <>
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-300 ml-0.5">/mo</span>
                      </>
                    )}
                  </div>
                </div>
        ...
        <Card padding="p-5" className="bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-base font-bold text-gray-900 dark:text-white">Need more groups?</h3>
          </div>
          ...
          <p className="text-xs text-gray-600 dark:text-gray-300 mb-4">Plans starting from only ₹20.</p>
