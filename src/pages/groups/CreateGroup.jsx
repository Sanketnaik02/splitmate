...
export default function CreateGroup() {
  ...
  const { plan, groupCount, atLimit } = useSubscription();
  ...
  return (
    <AppLayout userName={user?.displayName || 'User'}>
      <div className="pt-1">
        ...
        <Card padding="p-3" className="mb-4 flex items-center justify-between">
          <div>
            <p className="text-xs text-gray-500">Your Plan: <span className="font-semibold text-gray-700">{plan.name}</span></p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-4 space-y-3">
            <Button type="submit" fullWidth>Create Group</Button>
